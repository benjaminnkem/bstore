          ...
          <form onSubmit={(e) => handleProductCreation(e)}>
            <div className="grid gap-4">
              <div>
                ...
                {errors.itemName && <p className="text-red-500 text-opacity-75 text-xs font-bold">{errors.itemName}</p>}
              </div>
              ...
              <div>
                ...
                {errors.category && <p className="text-red-500 text-opacity-75 text-xs font-bold">{errors.category}</p>}
              </div>
