        ...
        <div className="md:max-w-[1024px] w-11/12 mx-auto">
          ...
          <div className="my-16">
            <div className="flex flex-wrap justify-evenly">
              <div className="grid max-w-xs p-6 m-4 mx-auto text-center duration-200 bg-green-100 shadow-md cursor-default rounded-2xl hover:rounded-3xl dark:bg-slate-800 place-content-center hover:shadow-2xl">
