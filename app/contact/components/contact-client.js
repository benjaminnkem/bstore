...
// import { contactThree } from "@/app/reuseable/three/contact/contact-three";
        ...
        <div className="md:grid gap-2 grid-cols-2 items-center">
          <div className="space-y-4 py-10 md:py-0 text-center md:text-start">
            ...
            <p className="dark:text-gray-400">
              Lorem ipsum dolor sit, amet consectetur adipisicing elit. Libero natus culpa asperiores vitae aspernatur,
              porro impedit. Sit dolore magnam consectetur similique odio aliquid eveniet at laboriosam!
            </p>
          </div>
