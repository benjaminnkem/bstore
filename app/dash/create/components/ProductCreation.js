              ...
              <form onSubmit={(e) => handleProductCreation(e)} encType="multipart/form-data">
                <div className="grid gap-4">
                  <div className="space-y-2">
                    ...
                    >
                      Pick Image <FontAwesomeIcon icon={faUpload} />
                    </div>
                    {errors.productImage && (
                      <p className="text-xs font-bold text-center text-red-500 text-opacity-75">
                        {errors.productImage}
                      </p>
                    )}
                  </div>
                  ...
                  <div>
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        className="block w-full bg-transparent border rounded-md p-2 outline-none duration-200 border-[#5c5c5c] focus:border-[#444554] placeholder:text-[#6e6e6e]"
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full py-2 rounded-md border border-[#5c5c5c] duration-200 hover:bg-[#2a2b35] hover:text-inherit disabled:opacity-40 disabled:bg-[#111115] disabled:hover:bg-[#111115]"
