...
const ProductImageBox = ({ errors, setFormInput, formInput }) => {
  // File Upload
        ...
        <div className="space-y-2">
          ...
          {localImageUrl ? (
            <div className="w-52 h-52 mx-auto overflow-hidden relative group duration-200 border-2 rounded-md border-[#474856] focus:border-[#444554] hover:border-opacity-50 z-0">
              <div className="absolute top-0 left-0 w-full h-full group-hover:bg-opacity-80 bg-opacity-0 bg-black flex items-center justify-center"></div>
              <Image
                src={localImageUrl}
                alt="Product Image"
                width={320}
